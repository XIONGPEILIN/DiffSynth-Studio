...
accelerate launch DiffSynth-Studio/examples/qwen_image/model_training/train.py \
  ...
  --num_epochs 20 \
  --save_steps 1000 \
  --output_path "train/Qwen-Image-Edit-2509_inpaint_lora_rank256_lr1e4_lorQK" \
  --lora_base_model "dit" \
  --lora_target_modules "to_q,to_k,add_q_proj,add_k_proj,to_out.0,to_add_out,img_mlp.net.2,img_mod.1,txt_mlp.net.2,txt_mod.1" \
  --lora_rank 256 \
  ...
  --wandb_name "lora-rank256-lr1e4-loraQK"